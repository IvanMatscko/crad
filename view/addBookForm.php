...
<div class="container">
    ...
    <div class="wrapper back">
        ...
        <form class="form_add" method="POST" action="../addBookAuthor.php">
            <h2>Добпаить книгу</h2>
            <div class="form-group">
                <label>Авторы</label>
                <select name="id_author" class="form-control options">
                    <option class="first">Выбрать</option>
                    <?php foreach ($submain as $row):?>
                        <option name="id_author" value="<?php echo $row['id_author'] ;?>"><?php echo $row['name'] ;?> </option>
                    <?php endforeach?>
                </select>
            </div>
            <div class="form-group">
                <label>Имя Книги</label>
                <input type="text" name="book_name" class="form-control" value="Имя книги">
            </div>
            <div class="form-group">
