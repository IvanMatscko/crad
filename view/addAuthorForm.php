...
<div class="container">
    ...
    <div class="wrapper back">
        ...
        <form class="form_add" method="POST" action="../addAuthorBook.php" >
            <h2>Добавить автора</h2>
            <div class="form-group">
                <label>Книги</label>
                <select name="id_book" class="form-control options">
                    <option class="first">Выбрать</option>
                    <?php foreach ($submain as $row):?>
                        <option name="id_book" value="<?php echo $row['id_book'] ;?>"><?php echo $row['book_name'] ;?> </option>
                    <?php endforeach?>
                </select>
            </div>
            <div class="form-group">
